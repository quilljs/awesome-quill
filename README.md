...
- [quill-find-replace-module_2](https://github.com/chewax/quill-find-replace-module) - Based on quill-find-replace-module find, replace, navigate back and forth and use regexp on search.
